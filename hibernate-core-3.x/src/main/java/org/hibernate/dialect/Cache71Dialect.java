...
/**
 * Cach&eacute; 2007.1 dialect. This class is required in order to use Hibernate with Intersystems CachÃ¯Â¿Â½ SQL.<br>
 * <br>
 * Compatible with CachÃ¯Â¿Â½ 2007.1.
 * <br>
 * <head>
...
public class Cache71Dialect extends Dialect {
	...
	/**
	 * Creates new <code>CachÃ¯Â¿Â½71Dialect</code> instance. Sets up the JDBC /
	 * CachÃ¯Â¿Â½ type mappings.
	 */
