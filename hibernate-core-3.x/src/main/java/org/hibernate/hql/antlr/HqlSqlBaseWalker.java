...
public HqlSqlBaseWalker() {
	...
	public final void insertablePropertySpec(AST _t) throws RecognitionException {
		...
		traceIn("insertablePropertySpec",_t);
		try { // debugging
	...
	public final void collectionFunction(AST _t) throws RecognitionException {
		...
		try { // debugging
			...
			traceOut("collectionFunction",_t);
		}
	}
	...
	public final void collectionFunctionOrSubselect(AST _t) throws RecognitionException {
		...
		traceIn("collectionFunctionOrSubselect",_t);
		try { // debugging
			...
			traceOut("collectionFunctionOrSubselect",_t);
		}
	}
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 18577898219802624L, 9004947591091340416L, 0L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 18718635708158000L, 9004947591095534720L, 0L, 0L};
		return data;
	}
