...
/**
 * Backported HHH-6589.
 * Skip BPM entity types as they are not supported.
 * 
 * @since 7.2.18
 * @author szacharov
 * 
...
public class EntityManagerFactoryImpl implements HibernateEntityManagerFactory {
    ...
    private static final String EIS_JBPM_PACKAGE = "com.exigen.bpm";
    private static final String JBPM_PACKAGE = "org.jbpm";
	...
	public EntityManagerFactoryImpl(
		...
		while (classes.hasNext()) {
		    ...
		    if (className.startsWith(JBPM_PACKAGE) || className.startsWith(EIS_JBPM_PACKAGE)) {
		       continue;
		    } else {
